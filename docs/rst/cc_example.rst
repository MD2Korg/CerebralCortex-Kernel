...
**Note:** If you don’t want to install it then simply export the path of
the CerebralCortex-Kernel directory:
...
To run these examples you just need to update configuration in the
following config file:

``CerebralCortex-Kernel-3.0/conf/cerebralcortex.yml``

-  Update filesystem storage path (i.e.,
...
If everything works well then example code will produce following
console logs:
